...
import {addTask, deleteTask, fetchTaskListData, updateTask} from '@velzon/store/Task/task_action';
import {selectTaskData, selectTaskLoading} from '@velzon/store/Task/task_selector';
import {cloneDeep} from 'lodash';
import {AssignedData} from '@velzon/core/data';
...
export class ListViewComponent {
  ...
  constructor(private modalService: NgbModal, public service: PaginationService
    , private formBuilder: UntypedFormBuilder, private store: Store<{
      data: RootReducerState
