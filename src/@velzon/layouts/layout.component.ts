...
import {VerticalComponent} from "@velzon/layouts/vertical/vertical.component";
import {HorizontalComponent} from "@velzon/layouts/horizontal/horizontal.component";
import {TwoColumnComponent} from "@velzon/layouts/two-column/two-column.component";
...
@Component({
  ...
  imports: [
    ...
    TranslateModule,
    NgbCollapseModule,
    FormsModule, ReactiveFormsModule, VerticalComponent, HorizontalComponent, TwoColumnComponent
  ]
})
