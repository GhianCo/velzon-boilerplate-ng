...
@Component({
  standalone: true,
  templateUrl: 'cuadre.suma.diaria.list.html',
...
export class CuadreSumaDiariaList {
   ...
   */
  onCuadrarSumaDiaria() {
    this.router.navigate(['/cuadre-suma-diaria/nuevo'])
  }

  cerrarTurno(id: any) {
    this.router.navigate(['/cuadre-suma-diaria/cerrar/' + id])
  }

  replicarInventario(id: any) {
    this.router.navigate(['/cuadre-suma-diaria/replicar/' + id])
  }
