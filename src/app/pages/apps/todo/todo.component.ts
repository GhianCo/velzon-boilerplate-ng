...
import {
  ...
  UntypedFormArray,
  Validators,
  UntypedFormControl, ReactiveFormsModule, FormsModule,
} from '@angular/forms';
import {
  NgbCollapse,
  NgbDropdown,
...
import {CdkDragDrop, CdkDragPlaceholder, CdkDropList, moveItemInArray} from '@angular/cdk/drag-drop';
// Sweet Alert
...
import { todoAssigned, todoProject } from '@appCore/data';
...
import {
  ...
  fetchTodoListData,
  updateTodo,
} from '@app/store/Todo/todo_action';
import {
  selectTodoData,
  selectTodoLoading,
} from '@app/store/Todo/todo_selector';
import { cloneDeep } from 'lodash';
import {SimplebarAngularModule} from "simplebar-angular";
import {DatePipe, NgClass} from "@angular/common";
import {FlatpickrModule} from "angularx-flatpickr";
import {SortByPipe} from "@app/pages/apps/sort-by.pipe";
