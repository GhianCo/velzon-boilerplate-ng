...
import { fetchKanbanListData } from '@app/store/Task/task_action';
import { RootReducerState } from '@app/store';
import { Store } from '@ngrx/store';
import { selectKanbanData, selectTaskLoading } from '@app/store/Task/task_selector';
import { TaskListModel } from '@app/store/Task/task_model';
